...
using UnityEngine.SceneManagement;//Para poder trabajar con elementos de la UI
...
public class UIController : MonoBehaviour
{
    ...
    public void UpdateCoinCount()
    {
        ...
        CoinText.text = LevelManager.sharedInstance.gemCollected.ToString();//Cast -> convertimos el número entero en texto para que pueda ser representado en la UI
    }
